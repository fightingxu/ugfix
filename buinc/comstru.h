...
// for queuename mark
#define P_QN_MARK    15       // 2007-11-7 15:30:46 queuename中的应答包标记位置，占5个字符位置
#define L_QN_MARK    5        // 2007-11-7 15:34:21 queuename中的应答包标记长度
#define BUREQ_MARK "BUREQ"    // 2010-11-29 18:14:27 推送出去的请求包标记
#define BUASW_MARK "BUASW"    // 2007-11-7 15:28:45 BU应答中的标记
#define MONASW_MARK "MONAW"   // 2007-11-7 15:31:47 MONITOR功能中的应答标记

#define PMMARK_HOSTNAME 28
...
/* ****** Added by CHENYH at 2010-1-15 16:31:51 *******/
#define MT_GETSVRFUNCREG   0x2005      // 查询在通信平台上注册了指定功能号的状态，仅仅DRTP4所有
typedef struct  
{
   unsigned short SourceNo;
   unsigned short FuncNo;
} __PACKED__ RP_GETSVRFUNCREG;
// AP_: int

#define MT_POSTBDATA    0x2006
typedef struct  
{
   char pushmode;  // 推送模式
   unsigned int acktime;   // 确认等待的时间
   unsigned int PostDestID;   // 消息目标点的ID
   unsigned short SourceNo;
   SYS_HEAD syshead;
} __PACKED__ RP_POSTBDATA;
