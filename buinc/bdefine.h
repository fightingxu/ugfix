...
#ifndef NOIPCS
// 函数名: BUSetMQName
// 编程  : 陈永华 2007-11-22 15:59:57
// 描述  : 为了能够支持MsgQueue模式
// 返回  : int  0 - 失败，不能支持MsgQueue模式；1-支持，成功准备好MsgQueue模式
// 参数  : const char *MQName [IN]: MsgQueue的命名
BUPUB_API int BUSetMQName(const char *MQName);
#endif
