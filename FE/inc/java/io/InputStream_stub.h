...
// it represents the Java object 'InputStream'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_IOINPUTSTREAM_STUB_H
	#define JAVA_IOINPUTSTREAM_STUB_H
...
namespace java{
	namespace io{
class InputStream_stub;


class DLL_EXPORT InputStream_stub : public Object_interface
{
public:
//////////////////////
// public Constructors
