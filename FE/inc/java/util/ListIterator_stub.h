...
// it represents the Java object 'ListIterator'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_UTILLISTITERATOR_STUB_H
	#define JAVA_UTILLISTITERATOR_STUB_H
...
namespace java{
	namespace util{
class ListIterator_stub;


class DLL_EXPORT ListIterator_stub : public ListIterator_interface
{
public:
//////////////////////
// public Constructors
