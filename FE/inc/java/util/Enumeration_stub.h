...
// it represents the Java object 'Enumeration'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_UTILENUMERATION_STUB_H
	#define JAVA_UTILENUMERATION_STUB_H
...
namespace java{
	namespace util{
class Enumeration_stub;


class DLL_EXPORT Enumeration_stub : public Enumeration_interface
{
public:
//////////////////////
// public Constructors
