...
// it represents the Java object 'Map'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_UTILMAP_STUB_H
	#define JAVA_UTILMAP_STUB_H
...
class DLL_EXPORT Map_stub : public Map_interface
{
public:
//////////////////////
// public Constructors
