...
//It represents the Java object 'Set_interface'.
//This file includs the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_UTIL_SET_INTERFACE_H
	#define JAVA_UTIL_SET_INTERFACE_H
...
class DLL_EXPORT Set_interface :  public java::util::Collection_interface
{
public:
//Public Methods
	//Destructor
	virtual ~Set_interface() { }
