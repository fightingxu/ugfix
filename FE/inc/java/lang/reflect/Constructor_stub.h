...
// it represents the Java object 'Constructor'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_LANG_REFLECTCONSTRUCTOR_STUB_H
	#define JAVA_LANG_REFLECTCONSTRUCTOR_STUB_H
...
class DLL_EXPORT Constructor_stub : public Object_interface
{
public:
//////////////////////
// public Constructors
