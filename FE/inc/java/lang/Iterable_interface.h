...
//It represents the Java object 'Iterable_interface'.
//This file includs the necessary wrappings for the JNI calls to the Java object.


#if !defined JAVA_LANG_ITERABLE_INTERFACE_H
	#define JAVA_LANG_ITERABLE_INTERFACE_H
...
class DLL_EXPORT Iterable_interface : public java::lang::Object_interface
{
public:
//Public Methods
	//Destructor
	virtual ~Iterable_interface() { }
