...
// it represents the Java object 'CMessageEnum'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined COM_SUNGARD_CS_FIX_FIXGATEWAY_API_CAPICMESSAGEENUM_STUB_H
	#define COM_SUNGARD_CS_FIX_FIXGATEWAY_API_CAPICMESSAGEENUM_STUB_H
		...
		namespace cs{
			namespace fix{
				namespace fixgateway{
					namespace api{
						namespace capi{
class CMessageEnum_stub;


class DLL_EXPORT CMessageEnum_stub : public Object_interface
{
public:
//////////////////////
// public Constructors
