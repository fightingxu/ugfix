...
// it represents the Java object 'CLogFactory'.
// this file includes the necessary wrappings for the JNI calls to the Java object.


#if !defined COM_SUNGARD_CS_FIX_FIXGATEWAY_API_CAPICLOGFACTORY_STUB_H
	#define COM_SUNGARD_CS_FIX_FIXGATEWAY_API_CAPICLOGFACTORY_STUB_H
		...
		namespace cs{
			namespace fix{
				namespace fixgateway{
					namespace api{
						namespace capi{
class CLogFactory_stub;


class DLL_EXPORT CLogFactory_stub : public Object_interface
{
public:
//////////////////////
// public Constructors
